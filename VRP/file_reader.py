...
f=open(fr'C:\Users\ADITI\PycharmProjects\FA_VRP\instances\P-VRP\{path}')

capacityLimit, graph, demand, optimalValue,trucks,dimension = RegExService.getData(path)
print("....")
print(dimension,capacityLimit,demand,optimalValue,trucks)

lines=f.readlines()
customers=[]
DIMENSION = int(dimension)
vehicle_num=int(trucks)
...
matrix = [[
    distance(customers[row]['XCOORD'],customers[row]['YCOORD'],customers[col]['XCOORD'],customers[col]['YCOORD'])
